...
namespace TicketShop.Map
{
    ...
    public partial class ZoomAndPanControl
    {
        ...
        /// <summary>
        /// Bring the specified ellipse to view.
        /// </summary>
        public Rect MakeVisible(Visual visual, Rect ellipse)
        {
            if (frameworkElement.IsAncestorOf(visual))
            {
                Rect transformedRect = visual.TransformToAncestor(frameworkElement).TransformBounds(ellipse);
