...
namespace TicketShop.Map
{
    ...
    public partial class ZoomAndPanControl : ContentControl, IScrollInfo
    {
        ...
        /// <summary>
        /// Do an animated zoom to view a specific scale and ellipse (in content coordinates).
        /// </summary>
        ...
        /// <summary>
        /// Do an animated zoom to the specified ellipse (in content coordinates).
        /// </summary>
        ...
        /// <summary>
        /// Instantly zoom to the specified ellipse (in content coordinates).
        /// </summary>
        ...
        public void AnimatedScaleToFit()
        {
            ...
            AnimatedZoomTo(new Rect(0, 0, frameworkElement.ActualWidth, frameworkElement.ActualHeight));
        }
        ...
        public void ScaleToFit()
        {
            ...
            ZoomTo(new Rect(0, 0, frameworkElement.ActualWidth, frameworkElement.ActualHeight));
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            frameworkElement = this.Template.FindName("PART_Content", this) as FrameworkElement;
            if (frameworkElement != null)
            {
                //
        ...
        protected override Size ArrangeOverride(Size arrangeBounds)
        {
            ...
            if (frameworkElement.DesiredSize != unScaledExtent)
            {
                //
                // Use the size of the child as the un-scaled extent content.
                //
                unScaledExtent = frameworkElement.DesiredSize;
